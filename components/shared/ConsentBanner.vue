<template>
  <div
    v-if="!consentGiven"
    class="fixed bottom-0 w-full p-4 text-center z-50 dark:bg-ternary-dark dark:text-ternary-light bg-slate-300"
  >
    <p class="mb-4">
    ...
    <button
      class="mx-2 px-4 py-2 bg-gray-500 text-white rounded hover:bg-gray-600"
